  ...
  up: async (queryInterface, _Sequelize) => {
    const postgrad = [
      ...
      },
      {
        ...
        curriculum: '',
        advisor: 'João Salinet',
        postgrad_resume: 'My participation in the research group as a Masters student in the Graduate Program in Biomedical Engineering is in the area of cardiac electrophysiology, with a focus on atrial fibrillation (AF). Continuing the projects already under development at Heartlab, I work on customizing the non-invasive electrocardiographic imaging method for generating electrophysiological maps of the epicardium. The in situ experiments will make it possible to study AF behaviors and patterns in the epicardium in a non-invasive way, which in the future may help electrophysiologists in planning to determine therapeutic strategies.',
